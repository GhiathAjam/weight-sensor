...
#define calibration_factor        60       // This value is obtained using the SparkFun_HX711_Calibration sketch
#define HX711_DOUT_PIN            D6         // dout pin
#define HX711_SCK_PIN             D5        // sck pin
#define NUM_OF_READINGS           3        // used to average on readings
